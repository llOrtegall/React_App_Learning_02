...
const images = [
  ...
  { titulo: 'Plataforma Simba', src: 'sinba.webp', alt: 'Carrousel Image 3', to: 'https://sinba.mercadosenlinea.co/menuprodbonos/MULTIRED' },
        ...
        {images.map((image, index) => (
          <a href={image.to} className="flex flex-col items-center hover:text-blue-600" target="_blank" rel="noopener noreferrer" >
            <img key={index} src={image.src} alt={image.alt}
              className="cursor-pointer object-cover rounded-full flex justify-center items-start gap-x-2 py-2 px-4 hover:scale-110 transition" />
